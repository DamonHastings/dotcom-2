...
const defaults: HighlightItem[] = [
  ...
  { label: 'Years', value: '15+', note: 'professional SWE experience' },
  { label: 'Community', value: '4 years', note: 'Non-Profit Leadership' },
    ...
    <section className="max-w-6xl mx-auto mb-12">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {list.map((it, i) => (
          <div
            key={i}
            className="bg-white/80 dark:bg-emerald-200/70 rounded-lg px-4 py-3 shadow-md"
          >
